"""
Internationalization (i18n) for the InfEngine editor.
...
The active locale is persisted to ``Documents/InfEngine/preferences.json``
...
# ---------------------------------------------------------------------------
# Persistence — Documents/InfEngine/preferences.json
# ---------------------------------------------------------------------------
