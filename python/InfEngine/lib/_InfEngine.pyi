"""
Python type stubs for the InfEngine C++ bindings module.
...
Provides IDE auto-completion and type checking for:
  ...
  - Editor (InfGUIContext, EditorCamera, InfEngine facade)
...
class MeshRenderer(Component):
    ...
    # Material (slot 0 compat)
    render_material: Optional[InfMaterial]
    material_guid: str

    # Multi-material API
    @property
    def material_count(self) -> int: ...
    def get_material(self, slot: int) -> Optional[InfMaterial]: ...
    def set_material(self, slot: int, guid: str) -> None: ...
    def get_effective_material(self, slot: int = 0) -> Optional[InfMaterial]: ...
    ...
    def get_mesh_asset(self) -> Optional[InfMesh]: ...
...
class GameObject:
    ...
    def add_component(self, component_type: Any) -> Optional[Component]: ...
    def remove_component(self, component: Component) -> bool: ...
    def can_remove_component(self, component: Component) -> bool: ...
    def get_remove_component_blockers(self, component: Component) -> List[str]: ...
    ...
    @staticmethod
    def instantiate(original: GameObject, parent: Optional[GameObject] = None) -> Optional[GameObject]: ...
    @staticmethod
...
class AssetRegistry:
    ...
    def load_material_by_path(self, path: str) -> Optional[InfMaterial]: ...
    def load_material_by_guid(self, guid: str) -> Optional[InfMaterial]: ...
    def get_material_by_path(self, path: str) -> Optional[InfMaterial]: ...
    def get_material_by_guid(self, guid: str) -> Optional[InfMaterial]: ...
    def load_mesh_by_path(self, path: str) -> Optional[InfMesh]: ...
    def load_mesh_by_guid(self, guid: str) -> Optional[InfMesh]: ...
    def get_mesh_by_path(self, path: str) -> Optional[InfMesh]: ...
    def get_mesh_by_guid(self, guid: str) -> Optional[InfMesh]: ...
    def get_builtin_material(self, name: str) -> Optional[InfMaterial]: ...
...
class ResourcePreviewManager:
    ...
    def render_preview(self, ctx: InfGUIContext, avail_width: float, avail_height: float) -> None: ...
...
class InfEngine:
    ...
    def register_gui_renderable(self, name: str, renderable: InfGUIRenderable) -> None: ...
