...
from InfEngine.components import SerializableObject, serialized_field, GameObjectRef
...
def _infer_argument_kind(annotation, default_value=inspect._empty) -> tuple[str, str]:
    ...
    try:
        ...
        if isinstance(annotation, type):
            ...
            if issubclass(annotation, InfComponent) and annotation is not InfComponent:
