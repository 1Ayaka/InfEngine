"""
Coroutine system — Unity-style cooperative multitasking for ``InfComponent``.

Usage (inside a component)::

    from InfEngine.coroutine import WaitForSeconds, WaitUntil
...
class CoroutineScheduler:
    """Internal scheduler — drives coroutines for a single ``InfComponent``.
    ...
    # -- Public API (used by InfComponent) ----------------------------------
