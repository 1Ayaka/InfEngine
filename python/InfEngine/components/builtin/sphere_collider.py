...
Example::
    ...
    from InfEngine.components.builtin import SphereCollider

    class MyScript(InfComponent):
        def start(self):
            col = self.get_component(SphereCollider)
            col.radius = 2.0
"""
...
class SphereCollider(Collider):
    ...
    def on_draw_gizmos_selected(self):
        ...
        # q * v: quaternion rotation of a vector
        cx, cy, cz = _quat_rotate(rot, local_center)
