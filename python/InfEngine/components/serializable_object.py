...
Supports the same ``serialized_field()`` descriptors as InfComponent, but
without lifecycle methods or undo/dirty tracking.  Can be nested inside
InfComponent fields or other SerializableObjects.

Example::

    from InfEngine.components import SerializableObject, serialized_field
...
_log = logging.getLogger("InfEngine.serialize")
...
class SerializableObject:
    ...
    as InfComponent field values (scalars or list elements).

    * Field declarations follow the same syntax as InfComponent
    ...
    * **No undo/dirty tracking** — that is handled at the InfComponent level.
    """
    ...
    # ------------------------------------------------------------------
    # Serialization helpers (used by InfComponent._serialize_value)
    # ------------------------------------------------------------------
...
# ======================================================================
# Private serialization helpers (mirror InfComponent._serialize_value
# but without the heavy InfComponent-specific imports)
# ======================================================================
