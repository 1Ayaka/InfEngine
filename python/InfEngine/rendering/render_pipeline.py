...
Exposing parameters:
    ...
    ``InfComponent``.  Declare class-level attributes and they will be
...
class RenderPipeline(RenderPipelineCallback):
    ...
    # Class-level storage for serialized field metadata (same pattern as InfComponent)
    ...
    # ------------------------------------------------------------------
    # __init_subclass__: auto-collect serialized fields
    # ------------------------------------------------------------------

    def __init_subclass__(cls, **kwargs):
        """Collect class-level serialized fields (same mechanism as InfComponent)."""
