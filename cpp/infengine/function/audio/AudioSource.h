 ...
 * InfEngine's AudioSource supports multiple tracks that share the same
 ...
 * - Play()             → plays track 0
 * - Get/SetClip()      → aliases for track 0 clip
 *
...
class AudioSource : public Component
{
  public:
    ...
    // ========================================================================
    // Backward-compatible API (operates on track 0)
    // ========================================================================
    ...
    // ========================================================================
    // Clip property (backward compat — aliases for track 0)
    // ========================================================================
