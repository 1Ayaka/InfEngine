...
using VkDeviceContextPtr = std::unique_ptr<VkDeviceContext>;
using VkSwapchainManagerPtr = std::unique_ptr<VkSwapchainManager>;
using VkPipelineManagerPtr = std::unique_ptr<VkPipelineManager>;
using VkResourceManagerPtr = std::unique_ptr<VkResourceManager>;
...
struct DeviceConfig
{
    const char *appName = "InfEngine App"; ///< Application name
    ...
    const char *engineName = "InfEngine";  ///< Engine name
