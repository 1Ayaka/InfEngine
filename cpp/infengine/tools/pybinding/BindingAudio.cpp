...
void RegisterAudioBindings(py::module_ &m)
{
    ...
    py::class_<AudioSource, Component>(m, "AudioSource",
        ...
        // Backward-compatible single-track properties
        .def_property_readonly("is_playing", &AudioSource::IsPlaying, "Whether track 0 is currently playing")
        .def_property_readonly("is_paused", &AudioSource::IsPaused, "Whether track 0 is paused")
        // Clip (backward compat — aliases for track 0)
        .def_property("clip", &AudioSource::GetClip, &AudioSource::SetClip,
                      "The AudioClip on track 0 (backward compat)")
