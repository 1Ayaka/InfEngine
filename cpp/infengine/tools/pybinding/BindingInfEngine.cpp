...
PYBIND11_MODULE(_InfEngine, m)
{
    ...
    py::class_<InfScreenUIRenderer>(m, "InfScreenUIRenderer")
        ...
        .def("add_image", &InfScreenUIRenderer::AddImage, py::arg("list"), py::arg("texture_id"), py::arg("min_x"),
        ...
        .def(
            "measure_text",
            [](const InfScreenUIRenderer &renderer, const std::string &text, float font_size, float wrap_width,
        ...
        .def("set_enabled", &InfScreenUIRenderer::SetEnabled, py::arg("enabled"),
             "Enable or disable rendering (commands still accumulate)")
        .def("is_enabled", &InfScreenUIRenderer::IsEnabled, "Check if rendering is enabled");

    py::class_<InfEngine>(m, "InfEngine")
        .def(py::init<std::string>(), py::arg("dll_path"))
        .def("init_renderer", &InfEngine::InitRenderer, py::arg("width"), py::arg("height"), py::arg("project_path"),
             py::arg("builtin_resource_path") = std::string())
        .def(
            "set_gui_font",
            [](InfEngine &self, const std::string &fontPath, float fontSize) {
        ...
        .def(
            ...
            [](InfEngine &self, const std::string &name, std::shared_ptr<InfGUIRenderable> renderable) {
                auto *r = self.GetRenderer();
                if (r)
        ...
        .def(
            ...
            [](InfEngine &self, const std::string &name) {
                auto *r = self.GetRenderer();
                if (r)
        ...
        .def(
            "set_window_icon",
            [](InfEngine &self, const std::string &iconPath) {
                auto *r = self.GetRenderer();
                if (r)
        ...
        .def(
            "set_fullscreen",
            [](InfEngine &self, bool fullscreen) {
                auto *r = self.GetRenderer();
                if (r)
        ...
        .def(
            "set_window_title",
            [](InfEngine &self, const std::string &title) {
                auto *r = self.GetRenderer();
                if (r)
        ...
        .def("reload_shader", &InfEngine::ReloadShader, py::arg("shader_path"),
             ...
             "failure.")
        .def("reload_texture", &InfEngine::ReloadTexture, py::arg("texture_path"),
             "Invalidate cached texture and force materials to reload it")
        .def("reload_mesh", &InfEngine::ReloadMesh, py::arg("mesh_path"),
             "Reload a mesh asset and notify dependent MeshRenderers")
        .def("reload_audio", &InfEngine::ReloadAudio, py::arg("audio_path"),
        ...
        .def(
            ...
            [](InfEngine &self, const std::string &name, const std::vector<unsigned char> &pixels, int width,
               int height) -> uint64_t {
                auto *r = self.GetRenderer();
        ...
        .def(
            "has_imgui_texture",
            [](InfEngine &self, const std::string &name) -> bool {
                auto *r = self.GetRenderer();
        ...
        .def(
            ...
            [](InfEngine &self, const std::string &name) -> uint64_t {
                auto *r = self.GetRenderer();
        ...
        .def(
            ...
            [](InfEngine &self) -> ResourcePreviewManager * {
                auto *r = self.GetRenderer();
        ...
        .def(
            ...
            [](InfEngine &self, uint32_t width, uint32_t height) {
                auto *r = self.GetRenderer();
                if (r)
        ...
        .def(
            ...
            [](InfEngine &self) -> InfScreenUIRenderer * {
                auto *r = self.GetRenderer();
        ...
        .def("pick_gizmo_axis", &InfEngine::PickGizmoAxis, py::arg("screen_x"), py::arg("screen_y"),
             py::arg("viewport_width"), py::arg("viewport_height"),
        ...
        .def("set_selection_outlines", &InfEngine::SetSelectionOutlines, py::arg("object_ids"),
        ...
        .def(
            ...
            [](InfEngine &self, const std::string &materialName) {
                auto *r = self.GetRenderer();
                if (r)
        ...
        .def(
            ...
            [](InfEngine &self) -> SceneRenderGraph * {
                auto *r = self.GetRenderer();
